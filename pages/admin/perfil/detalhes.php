...
if (isset($_GET['id'])) {
   $perfil = buscarPerfilAction($_GET['id']) ?? header("Location: ./index.php");
}
?>
         <div class="container-fluid">
            ...
            <div class="row" style="overflow-y: auto; height:100vh;">
               <div class="col"> 
               <h1>Visualizar Perfil de Usuário</h1>
                  <div class="form-group">
                     <label>Descrição</label>
                     <input readonly value="<?=!empty($perfil['descricao']) ? htmlspecialchars($perfil['descricao']) : ""?>" type="text" class="form-control"><br/>
                  </div>
