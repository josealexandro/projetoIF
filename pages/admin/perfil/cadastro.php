...
if (isset($_POST["cadastrar"])) criarPerfilAction($_POST);
if (isset($_POST["alterar"])) alterarPerfilAction($_POST); 

if (isset($_GET['id'])) {
   $perfil = buscarPerfilAction($_GET['id']) ?? header("Location: ".$_SERVER['PHP_SELF']);
   $cod_perfil = $_GET['id'];
}

$editMode = isset($perfil);
?>
